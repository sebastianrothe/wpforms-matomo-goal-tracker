 ...
 * @subpackage Wpforms_Matomo_Goal_Tracker/public
 */
 ...
 */
class Wpforms_Matomo_Goal_Tracker_Public
{
    ...
    public function enqueue_styles()
    {
        ...
        //wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wpforms-matomo-goal-tracker-public.css', array(), $this->version, 'all' );
